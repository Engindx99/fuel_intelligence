...
class Preheater:
    ...
    def __init__(self, N=5, L=25.0):
        ...
        # ================= DYNAMIC FLOW =================
        # Updated in apply() from previous zone
    ...
    def apply(self, state, dt):
        ...
        state.Hgas_preheater_out = self.gas_enthalpy_out(state.Tg_preheater, state)
        state.Hsolid_preheater_out = self.solid_enthalpy_out(state.Ts_preheater, state)
